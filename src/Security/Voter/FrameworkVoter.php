...
class FrameworkVoter extends AbstractVoter
{
     ...
     * @return bool
     */
    protected function canUpdate($subject, $user): bool
    {
     ...
     * @return bool
     */
    protected function canImport($subject, $user): bool
    {
        return $this->common($subject, $user, SecurityConstant::ROLE_ADMIN);
    }
     ...
     * @return bool
     */
    protected function canExport($subject, $user): bool
    {
        return $this->common($subject, $user, SecurityConstant::ROLE_ADMIN);
    }
     ...
     * @return bool
     *
     * @SuppressWarnings(PHPMD.UnusedFormalParameter) on Closure $key
     */
    private function common($subject, ?UserInterface $user, string $role = SecurityConstant::ROLE_USER): bool
    {
        ...
        return $subject->getUserFrameworks()->exists(function (int $key, UserFramework $value) use ($role, $user) {
