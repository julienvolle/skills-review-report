...
class InterviewController extends AbstractController
{
     ...
     *
     * @ParamConverter("interview", class=Interview::class)
     *
     * @param Request   $request
    ...
    private function handleForm(FormInterface $form): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            try {
                ...
                $this->addFlash('success', $this->translator->trans('flash.interview.saved', [], 'alertes'));
    ...
    public function delete(Interview $interview): Response
    {
        ...
        try {
            ...
            $this->addFlash('success', $this->translator->trans('flash.interview.removed', [], 'alertes'));
