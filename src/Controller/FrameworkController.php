...
class FrameworkController extends AbstractController
{
     ...
     */
    public function __construct(FrameworkService $frameworkService, TranslatorInterface $translator)
    {
    ...
    public function create(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            try {
                ...
                $this->addFlash('success', $this->translator->trans('flash.framework.saved', [], 'alertes'));
     ...
     *
     * @ParamConverter("framework", class=Framework::class)
     *
     * @param Request   $request
    ...
    public function delete(Framework $framework): Response
    {
        ...
        try {
            ...
            $this->addFlash('success', $this->translator->trans('flash.framework.removed', [], 'alertes'));
