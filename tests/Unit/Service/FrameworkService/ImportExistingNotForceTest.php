 ...
 * @group unit
 */
class ImportExistingNotForceTest extends AbstractTestFrameworkService
{
    public function testImportExistingNotForce(): void
    {
        ...
        $this->getProphecy(TranslatorInterface::class)
            ->trans(
                Argument::exact('exception.framework.import.already_exist'),
                Argument::type('array'),
        ...
        $this->frameworkService->import($framework, false); // Don't force
    }
}
